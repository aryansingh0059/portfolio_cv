...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Animated Background Elements (still, but no hover-glow) */}
          ...
          >
            <Link href="#about-me" className="flex items-center group">
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500/40 to-cyan-500/40"
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.3, 0.6, 0.3],
                  }}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            className="absolute top-full left-0 w-full bg-[#030014]/99 border-t-2 border-purple-500/40 md:hidden overflow-hidden rounded-b-3xl shadow-xl shadow-black/50"
            ...
            >
              {NAV_LINKS.map((link) => (
                ...
                >
                  <Link
                    href={link.link}
                    className="cursor-pointer text-gray-300 hover:text-white text-xl font-medium transition-all duration-300 relative group py-4 block rounded-2xl bg-gradient-to-r from-transparent to-purple-500/10 hover:to-purple-500/15 border border-transparent hover:border-purple-500/30"
                ...
                {SOCIALS.map(({ link, name, icon: Icon }) => (
                  ...
                  >
                    <Link
                      ...
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <div className="p-4 rounded-2xl bg-gradient-to-br from-purple-500/30 to-cyan-500/30 border border-purple-500/50 group-hover:border-cyan-400/60 transition-all duration-300">
      ...
      {/* Progress Bar */}
      <motion.div
        className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500 rounded-full shadow-md shadow-purple-500/40"
